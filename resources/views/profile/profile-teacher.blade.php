    ...
    <div class="container rounded bg-white mt-5 mb-5">
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><span class="font-weight-bold">{{ $teacher->fullname }}</span><span class="text-black-50">{{ $teacher->email }}</span><span> </span></div>
            </div>
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">講師プロフィール</h4>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-12"><label class="labels">名前</label><input type="text" class="form-control" placeholder="名前" value="{{ $teacher->fullname }}" disabled></div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">性別</label><input type="text" class="form-control" placeholder="性別" value="{{$teacher->gender}}" disabled></div>
                        <div class="col-md-12"><label class="labels">指定</label><input type="text" class="form-control" placeholder="指定" value="{{$teacher->designation}}" disabled></div>
                        <div class="col-md-12"><label class="labels">スキル</label><input type="text" class="form-control" placeholder="スキル" value="{{$teacher->skills}}" disabled></div>
                        <div class="col-md-12"><label class="labels">経験</label><input type="text" class="form-control" placeholder="経験" value="{{$teacher->experience}}" disabled></div>
                        <div class="col-md-12"><label class="labels">説明</label><input type="text" class="form-control" placeholder="説明" value="{{$teacher->description}}" disabled></div>
                    </div>
                </div>
            </div>
        </div>
